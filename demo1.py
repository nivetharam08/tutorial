...
class Management:
    def __init__(self, root):
        ...
        # Left Frame
        self.frame_1 = Frame(self.window, bg = self.color_3)
        self.frame_1.place(x=0, y=0, width=320,height =400)

       
        # Right Frame
        self.frame_2 = Frame(self.window, bg = self.color_2)
        self.frame_2.place(x=0,y=0,width=940, height=680)
        

        # Buttons
        self.add_bt = Button(self.frame_2, text='SIGN UP', font=(self.font_1, 12), bd=2, command=self.AddStudent, cursor="hand2",
                      bg=self.color_4,fg=self.color_3).place(x=30,y=40,width=90)
        self.view_bt = Button(self.frame_2, text='LOG IN', font=(self.font_1, 12), bd=2, command=self.GetContact_View,
                      cursor="hand2", bg=self.color_4,fg=self.color_3).place(x=30,y=110,width=90)
        self.update_bt = Button(self.frame_2, text='UPDATE', font=(self.font_1, 12), bd=2, command=self.GetContact_Update, cursor="hand2",
                      bg=self.color_4,fg=self.color_3).place(x=30,y=180,width=90)
        self.delete_bt = Button(self.frame_2, text='DELETE', font=(self.font_1, 12), bd=2, command=self.GetContact_Delete,cursor="hand2",
                      bg=self.color_4,fg=self.color_3).place(x=30,y=250,width=90)
        self.clear_bt = Button(self.frame_2, text='CLEAR', font=(self.font_1, 12), bd=2, command=self.ClearScreen, cursor="hand2",
                      bg=self.color_4,fg=self.color_3).place(x=30,y=320,width=90)
        
        self.date_bt = Button(self.frame_2, text='DATE', font=(self.font_1, 12), bd=2, command=self.date,cursor="hand2", bg=self.color_4,
                      fg=self.color_3).place(x=30,y=390,width=90)
        self.exit_bt = Button(self.frame_2, text='EXIT', font=(self.font_1, 12), bd=2, command=self.Exit,cursor="hand2", bg=self.color_4,
                      fg=self.color_3).place(x=30,y=460,width=90)
    ...
    def AddStudent(self):
        ...
        self.name = Label(self.frame_2, text="First Name", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=200,y=20)
        self.name_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.name_entry.place(x=200,y=50, width=200)
        ...
        self.course = Label(self.frame_2, text="Course", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=200,y=80)
        self.course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.course_entry.place(x=200,y=110, width=200)
        ...
        self.date = Label(self.frame_2, text="Date", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=200,y=140)
        self.date_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.date_entry.place(x=200,y=170, width=200)
        ...
        self.gender = Label(self.frame_2, text="Gender", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=200,y=200)
        self.gender_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.gender_entry.place(x=200,y=230, width=200)
        ...
        self.contact = Label(self.frame_2, text="Contact No", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=200,y=260)
        self.contact_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.contact_entry.place(x=200,y=290, width=200)
        ...
        self.Current_Course = Label(self.frame_2, text="Current Course", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=200,y=320)
        self.Current_Course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Current_Course_entry.place(x=200,y=350, width=200)
        ...
        self.Completed_Course = Label(self.frame_2, text="Completed Course", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=200,y=380)
        self.Completed_Course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Completed_Course_entry.place(x=200,y=410, width=200)
        ...
        self.Paid_Fees = Label(self.frame_2, text="Paid Fees", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=200,y=440)
        self.Paid_Fees_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Paid_Fees_entry.place(x=200,y=470, width=200)
